...
(function () {
  ...
  var OS_ICON = {
    macos: '<svg class="dl-os-ico" viewBox="0 0 24 24" fill="#e6edf3" aria-hidden="true"><path d="M16.4 1.9c0 1-.4 2-1.1 2.8-.8.9-2 1.6-3.1 1.5-.1-1 .4-2.1 1.1-2.8.8-.9 2.1-1.5 3.1-1.5zM20 17.1c-.5 1.2-.8 1.8-1.5 2.9-1 1.5-2.4 3.4-4.1 3.4-1.5 0-1.9-1-4-1-2 0-2.5 1-4 1-1.7 0-3-1.7-4-3.2-2.8-4.2-3.1-9.2-1.4-11.9 1.2-1.9 3.1-3 4.9-3 1.8 0 3 1 4.5 1 1.5 0 2.4-1 4.5-1 1.6 0 3.3.9 4.5 2.4-3.9 2.2-3.3 7.8.1 9.4z"/></svg>',
    windows: '<svg class="dl-os-ico" viewBox="0 0 24 24" fill="#58a6ff" aria-hidden="true"><path d="M3 5.5 10.5 4.4v7.1H3zM3 12.5h7.5v7.1L3 18.5zM11.5 4.2 21 3v8.5h-9.5zM11.5 12.5H21V21l-9.5-1.3z"/></svg>',
    linux: '<svg class="dl-os-ico" viewBox="0 0 24 24" fill="#ffa940" aria-hidden="true"><path d="M12 2c2 0 3 1.8 3 4 0 1.5-.6 2.4-.6 3.6 0 .8.6 1.3 1.4 2.6.9 1.4 2.2 3.2 2.2 5.3 0 1.7-1 2.9-2.4 3.4.2.4.3.8.3 1.1H7.1c0-.3.1-.7.3-1.1C6 22.9 5 21.7 5 20c0-2.1 1.3-3.9 2.2-5.3.8-1.3 1.4-1.8 1.4-2.6 0-1.2-.6-2.1-.6-3.6 0-2.2 1-4 3-4z"/></svg>',
    android: '<svg class="dl-os-ico" viewBox="0 0 24 24" fill="#7ee787" aria-hidden="true"><path d="M6 9h12v8a1 1 0 0 1-1 1h-1v3h-2v-3h-2v3H9v-3H7a1 1 0 0 1-1-1zM4 9.5A1.5 1.5 0 0 1 5.5 11v4A1.5 1.5 0 0 1 2.5 15v-4A1.5 1.5 0 0 1 4 9.5zM20 9.5A1.5 1.5 0 0 1 21.5 11v4A1.5 1.5 0 0 1 18.5 15v-4A1.5 1.5 0 0 1 20 9.5zM7.5 8a4.5 4.5 0 0 1 9 0z"/></svg>',
    ios: '<svg class="dl-os-ico" viewBox="0 0 24 24" fill="#e6edf3" aria-hidden="true"><path d="M16.4 1.9c0 1-.4 2-1.1 2.8-.8.9-2 1.6-3.1 1.5-.1-1 .4-2.1 1.1-2.8.8-.9 2.1-1.5 3.1-1.5zM20 17.1c-.5 1.2-.8 1.8-1.5 2.9-1 1.5-2.4 3.4-4.1 3.4-1.5 0-1.9-1-4-1-2 0-2.5 1-4 1-1.7 0-3-1.7-4-3.2-2.8-4.2-3.1-9.2-1.4-11.9 1.2-1.9 3.1-3 4.9-3 1.8 0 3 1 4.5 1 1.5 0 2.4-1 4.5-1 1.6 0 3.3.9 4.5 2.4-3.9 2.2-3.3 7.8.1 9.4z"/></svg>'
  }
